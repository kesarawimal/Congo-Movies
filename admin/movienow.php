...
?>
	...
	$name = $link = $imdb = $category = $imgname = "";
...
if($conn->query("insert into movienow (name,image,link,imdb,category) values ('$name','image/$imgname','$link','$imdb','$category');"))
{echo "<p style='color:red'>your movie successfully uploaded!</p>";}Else{echo "<p style='color:red'>an error occurred where uploading the movie!</p>";}
    ...
    <body>
<h1>Upload a Now Showing Movie</h1>
        <form action="movienow.php" method="post" enctype="multipart/form-data">

            <h3>Name:</h3> <input type="text" name="name" size="100"> <br>
			<h3>Link:</h3> <input type="text" name="link" size="100"> <br>
			<h3>imdb:</h3> <input type="text" name="imdb"> <br>
